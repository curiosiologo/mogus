...
<main class="relative z-10 bg--200 flex flex-row p-4 gap-8 box-shadow">
  <div class="w-full">
    ...
    <div class="p-4 grid gap-4 grid-cols-3">
      ...
      <div class="animate-[pulse_1s_ease-in-out_3]" v-for="(ninja, index) in ninjas" ><Ninja :name="ninja[2]" :show_tasks="false" :isImpostor="false" :isDead="ninja[3] != null" :onCooldown="false" :idx="index" progress="75%"/></div>
    </div>
